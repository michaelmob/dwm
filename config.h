...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-e", "math_scratchpad.py", "-g", "120x34", NULL };
static const char *flameshotcmd[] = { "flameshot", "gui", NULL };
static const char *toggleplaybackcmd[] = { "playerctl", "play-pause", NULL };
...
static Key keys[] = {
	...
	{ 0,                            XK_Pause,  spawn,          {.v = toggleplaybackcmd } },
